	...
	describe('methods', () => {
		describe('setupChartData', () => {
			...
			it('should define the chartData property', () => {
				...
				wrapper
					.instance()
					.chartData.scenariosChartData.should.be.an('Array');
				wrapper
					.instance()
					.chartData.stepsChartData.should.be.an('Array');
			});
		});
		...
		describe('_getScenariosTooltip', () => {
			...
			describe('HTML', () => {
				const scenarioTooltipLayout = shallow(
					wrapper
						.instance()
						._getScenariosTooltip(
							1,
							null,
							null,
							'Hello World',
				...
				describe('container', () => {
					it('should present the class name', () => {
						scenarioTooltipLayout
							.find('div')
							.hasClass('wrapper-scenario-chart-tooltip').should
							.be.true;
					});
				});
				...
				describe('subtitle', () => {
					...
					it('should present the class name', () => {
						scenarioTooltipLayout
							.find('h4')
							.hasClass('single-scenario-file').should.be.true;
					});
				});
				...
				describe('duration', () => {
					...
					it('should present the class name', () => {
						scenarioTooltipLayout
							.find('h5')
							.hasClass('single-scenario-duration').should.be
							.true;
					});
				});
			});
		...
		describe('_getStepsTooltip', () => {
			...
			describe('HTML', () => {
				const stepTooltipLayout = shallow(
					wrapper
						.instance()
						._getStepsTooltip(1, null, null, 'Hello World', null)
				);
