...
describe('FilterLink Container Component', () => {
    ...
    describe('general', () => {
        it('should be defined', () => {
            wrapper = shallow(<FilterLinkContainer filter="blablabla" store={store}>Text</FilterLinkContainer>);
    ...
    describe('state props', () => {
        describe('active', () => {
            ...
            it('should be true if filter prop is equal to the visibilityFilter state', () => {
                wrapper = shallow(<FilterLinkContainer filter="MY FILTER" store={store}>Text</FilterLinkContainer>);
